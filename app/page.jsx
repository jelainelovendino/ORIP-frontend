    ...
    <div className="min-h-screen bg-[#d7dff0] font-sans">
      ...
      <section className="bg-blue-200 mt-12 py-8 text-center">
        <div className="max-w-5xl mx-auto px-8">
          <h2 className="text-lg md:text-2xl font-bold text-blue-900 mb-3 md:mb-6">Trusted by the Community</h2>
          <div className="flex flex-wrap justify-center gap-3 md:gap-16">
            <div className="flex flex-col items-center">
              <div className="text-base md:text-2xl font-extrabold text-blue-900 leading-none">150+</div>
              <div className="mt-0.5 md:mt-1 text-xs md:text-sm font-semibold text-blue-900/90">
                Active Researchers
              </div>
            </div>
            <div className="flex flex-col items-center">
              <div className="text-base md:text-2xl font-extrabold text-blue-900 leading-none">300+</div>
              <div className="mt-0.5 md:mt-1 text-xs md:text-sm font-semibold text-blue-900/90">
                Projects Shared
              </div>
            </div>
            <div className="flex flex-col items-center">
              <div className="text-base md:text-2xl font-extrabold text-blue-900 leading-none">50+</div>
              <div className="mt-0.5 md:mt-1 text-xs md:text-sm font-semibold text-blue-900/90">
                Universities
              </div>
            </div>
      ...
      {/* FOOTER CTA */}
      <section className="text-center py-8 md:py-16 px-4 md:px-6 border-t border-blue-300 mt-8">
        <h2 className="text-xl md:text-3xl font-extrabold text-blue-900 mb-2 md:mb-4">
          Ready to Share Your Work?
        </h2>
        <p className="text-xs md:text-lg max-w-2xl mx-auto leading-relaxed text-blue-900/90 mb-4 md:mb-8">
          Join hundreds of researchers and innovators building their portfolios on our platform.
        </p>
        <a
          href="/login"
          className="px-6 md:px-8 py-2 md:py-3 rounded-full bg-blue-700 text-white font-semibold shadow-md hover:shadow-xl hover:bg-blue-800 transition-all text-xs md:text-base transform hover:scale-105 active:scale-95"
        >
          Get Started Now
        </a>
      </section>
      ...
      {/* FOOTER */}
      <footer className="bg-blue-900 text-blue-100 py-4 md:py-8 mt-8 md:mt-16 text-center">
